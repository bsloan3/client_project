...
rating = Rating.create(rating: 2, user_id: 1, recipe_id: 12)
rating = Rating.create(rating: 1, user_id: 1, recipe_id: 13)
rating = Rating.create(rating: 5, user_id: 2, recipe_id: 14)
rating = Rating.create(rating: 2, user_id: 2, recipe_id: 15)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 16)
rating = Rating.create(rating: 5, user_id: 2, recipe_id: 17)
rating = Rating.create(rating: 3, user_id: 2, recipe_id: 18)
rating = Rating.create(rating: 4, user_id: 2, recipe_id: 19)
