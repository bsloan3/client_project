...
penn_salad = Recipe.create(name:"Penn's Southern Salad", difficulty_level: 4, prep_time: 30, directions:"This is what I eat when im trying to be healthy. Just mix all the ingredients together", user: penn, category: 'Salad')
...
waldorf_salad = Recipe.create(name:"waldorf_salad", difficulty_level: 2, prep_time: 20, directions:"In a medium sized bowl, whisk together the mayonnaise (or yogurt), lemon juice, salt and pepper. Stir in the apple, celery, grapes, and walnuts. Serve on a bed of fresh lettuce.", user: penn, category: 'Salad')
...
rating = Rating.create(rating: 1, user_id: 1, recipe_id: 1)
rating = Rating.create(rating: 1, user_id: 1, recipe_id: 2)
rating = Rating.create(rating: 1, user_id: 1, recipe_id: 3)
rating = Rating.create(rating: 1, user_id: 1, recipe_id: 4)
rating = Rating.create(rating: 1, user_id: 1, recipe_id: 5)
rating = Rating.create(rating: 1, user_id: 1, recipe_id: 6)
rating = Rating.create(rating: 1, user_id: 1, recipe_id: 7)
rating = Rating.create(rating: 1, user_id: 1, recipe_id: 12)
rating = Rating.create(rating: 1, user_id: 1, recipe_id: 13)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 14)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 15)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 16)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 17)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 18)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 19)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 20)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 21)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 22)
