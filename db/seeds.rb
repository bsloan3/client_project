...
Recipe.create(name: 'Ceasar Salad', difficulty_level: 2, prep_time: 10, directions: "Chop lettuce and place in bowl. Add chicken, dressing, cheese, crutons and mix.", user_id: 2, category: 'Salad')
  ...
  Ingredient.create(item: 'Chips', amount: 1, measurement: 'lb', recipe_id: 15)
...
Recipe.create(name: 'Cookies', difficulty_level: 2, prep_time: 50, directions: "Place dough on pan in balls or whatever shape you want. Put in Oven on 350 for 45 mins.", user_id: 1, category: 'Dessert')
  Ingredient.create(item: 'Lettuce', amount: 1, measurement: 'head', recipe_id: 16)
  Ingredient.create(item: 'Lettuce', amount: 1, measurement: 'head', recipe_id: 16)
  Ingredient.create(item: 'Lettuce', amount: 1, measurement: 'head', recipe_id: 16)
  Ingredient.create(item: 'Parmesan', amount: 4, measurement: 'oz', recipe_id: 16)
    Rating.create(rating: 1, user_id: 5, recipe_id: 16)
    Rating.create(rating: 1, user_id: 6, recipe_id: 16)
    Rating.create(rating: 1, user_id: 3, recipe_id: 16)
    Rating.create(rating: 1, user_id: 10, recipe_id: 16)
