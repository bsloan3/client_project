...
penn_salad = Recipe.create(name:"Penn's Southern Salad", difficulty_level: 4, prep_time: 30, directions:"This is what I eat when im trying to be healthy. Lightly tossed", user: penn, category: 'Salad')
...
waldorf_salad = Recipe.create(name:"Waldorf Salad", difficulty_level: 2, prep_time: 20, directions:"In a medium sized bowl, whisk together the mayonnaise (or yogurt), lemon juice, salt and pepper. Stir in the apple, celery, grapes, and walnuts. Serve on a bed of fresh lettuce.", user: penn, category: 'Salad')
...
burgers = Recipe.create(name:"Brad's Baller Bugers", difficulty_level: 3, prep_time: 30, directions:"The key to a good baller burger is love and care.  Next most important is the rosemary, mix thoughly in with the meat.  Cook a min shorter than you would think.", user: brad, category: 'Main Course')
...
dumplings = Recipe.create(name:"Thomas's Mountain of Dumplings", difficulty_level: 1, prep_time: 10, directions:"You poor af??? Then look no shorter than Vanessa's Dumplings.  You buy them bye the sack and then boil them up.", user: thomas, category: 'Main Course')
...
cookies = Recipe.create(name:"Mina's miricle cookies", difficulty_level: 2, prep_time: 15, directions:"DBC student, yet you dont't know mina????? Then your not trying hard enough, she is the lovely women who tides the space for us in the evening after hours.  She is super nice and loves chocolate chip cookies.  Mix the ingredients bellow and place on non-greased cooking sheet.  Bake at 350 degrees for 20 min.  Let cool, even though its so hard.", user: mina, category: 'Dessert')
...
cake = Recipe.create(name:"Najah's Sucide Cheese Cake", difficulty_level: 5, prep_time: 45, directions:"I am lactose intolerant, this cake kills me, BUT its worth it.  Crafted using only the finest ingredients, this cake will change your perception of reality.  Mix the indgredients together, bake for 25 min.", user: najah, category: 'Dessert')
...
ingredient = Ingredient.create(item: 'Crutons', amount: 7, measurement: 'squares', recipe_id: 15)
ingredient = Ingredient.create(item: 'Chicken', amount: 1, measurement: 'lb', recipe_id: 15)
ingredient = Ingredient.create(item: 'Chips', amount: 1, measurement: 'lb', recipe_id: 15)
ingredient = Ingredient.create(item: 'Guac', amount: 1, measurement: 'lb', recipe_id: 15)
rating = Rating.create(rating: 1, user_id: 2, recipe_id: 15)
rating = Rating.create(rating: 2, user_id: 1, recipe_id: 15)
rating = Rating.create(rating: 1, user_id: 8, recipe_id: 15)
rating = Rating.create(rating: 2, user_id: 9, recipe_id: 15)

Recipe.create(name: 'Cookies', difficulty_level: 2, prep_time: 50, directions: "Place dough on pan in balls or whatever shape you want. Put in Oven on 350 for 45 mins.", user_id: 1, category: 'Dessert')
ingredient = Ingredient.create(item: 'Lettuce', amount: 1, measurement: 'head', recipe_id: 16)
ingredient = Ingredient.create(item: 'Lettuce', amount: 1, measurement: 'head', recipe_id: 16)
ingredient = Ingredient.create(item: 'Lettuce', amount: 1, measurement: 'head', recipe_id: 16)
ingredient = Ingredient.create(item: 'Parmesan', amount: 4, measurement: 'oz', recipe_id: 16)
rating = Rating.create(rating: 1, user_id: 5, recipe_id: 16)
rating = Rating.create(rating: 1, user_id: 6, recipe_id: 16)
rating = Rating.create(rating: 1, user_id: 3, recipe_id: 16)
rating = Rating.create(rating: 1, user_id: 10, recipe_id: 16)
